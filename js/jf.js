...
{
var tmptxt=cgjf_Obj.innerHTML.toString()
if(tmptxt.indexOf("简")<0)
{
BodyIsFt=1
cgjf_Obj.innerHTML=StranText(tmptxt,0,1)
cgjf.title=StranText(cgjf.title,0,1)
}
else
{
BodyIsFt=0
cgjf_Obj.innerHTML=StranText(tmptxt,1,1)
cgjf.title=StranText(cgjf.title,1,1)
}
...
{
var OO=obj.item(i)
if("||BR|HR|TEXTAREA|".indexOf("|"+OO.tagName+"|")>0||OO==cgjf_Obj)continue;
...
document.cookie = name + "=" + escape (value)+ ";domain=.cngba.com" +((expires == null) ? "" : ("; expires=" +LargeExpDate.toGMTString()));
}
...
var cgjf_Obj=document.getElementById("cgjf")
if (cgjf_Obj)
{
//var JF_cn="ft"+self.location.hostname.toString().replace(/\./g,"")
var JF_cn="isgb5cngba";
...
function set_p_cookie(Name)
{

var cookie_time = 12*60*60;
